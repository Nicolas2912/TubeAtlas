...
from tubeatlas.kg_builder_langchain import KnowledgeGraphBuilder, GraphBuilderConfig
...
def main():
    ...
    try:
        ...
        print()
        print("🎉 You can now start the API server and frontend to visualize the knowledge graph!")
