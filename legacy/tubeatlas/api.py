...
from kg_builder_langchain import GraphBuilderConfig, KnowledgeGraphBuilder
...
class KnowledgeGraphRequest(BaseModel):
    ...
    additional_instructions: Optional[str] = Field(
        None, description="Additional instructions for graph building"
    )
...
async def download_channel_transcripts(
    request: ChannelDownloadRequest, background_tasks: BackgroundTasks
) -> DownloadResponse:
    """
...
async def build_knowledge_graph(
    request: KnowledgeGraphRequest, background_tasks: BackgroundTasks
...
async def process_channel_download(
    task_id: str, channel_url: str, storage_type: str, region_code: str
) -> None:
    ...
    try:
        ...
        download_tasks[task_id][
            "message"
        ] = f"Successfully processed {successful} videos"
