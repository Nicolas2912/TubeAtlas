...
class ChatService:
    ...
    async def query_video(self, video_id: str, query: str, session_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def query_channel(self, channel_id: str, query: str, session_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def query_knowledge_graph(self, kg_id: str, query: str, session_id: Optional[str] = None) -> Dict[str, Any]:
